        ...
        {activeTab === "default" ? (
          <nav className="flex-1 overflow-y-auto py-2">
            {sortedGroups.map((group, idx) => {
              ...
              const firstUnpinned =
                idx > 0 && !isPinned && pinned.has(sortedGroups[idx - 1].label);
              return (
                <div key={group.label} className="mb-1">
                  {firstUnpinned && (
                    <div className="mx-3 mb-1 border-t border-dashed border-border/60" />
                  )}
                  ...
                  {renamingId === view.id ? (
                    <div className="flex flex-1 flex-col min-w-0 py-0.5 pr-1">
                      <input
                        ...
                        onBlur={() => {
                          if (!renameSavedViewMutation.isPending) {
                            setRenamingId(null);
                            setRenameError("");
                          }
                        }}
